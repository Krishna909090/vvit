...
export const createTransportRoute = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
    ...
    const { name, city, cost, busNumber, capacity } = req.body;
    const adminId = req.user?.userId;

    const route = await TransportService.createTransportRoute(name, city, cost, busNumber, capacity, adminId);
...
export const updateVehicle = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
    ...
    const updatedVehicle = await TransportService.updateVehicle(id, number, capacity, driverName, driverPhone, req.user?.userId);
...
export const updateTransportStop = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
    ...
    const updatedStop = await TransportService.updateTransportStop(id, name, routeId, sequence, pickupTime, dropTime, req.user?.userId);
