...
export enum AuditAction {
    ...
    STUDENT_PURGED = 'STUDENT_PURGED',
    USER_HARD_DELETED = 'USER_HARD_DELETED',
    PAYMENT_HARD_DELETED = 'PAYMENT_HARD_DELETED',
    FEE_DEMAND_HARD_DELETED = 'FEE_DEMAND_HARD_DELETED',
    FEE_CORRECTION_HARD_DELETED = 'FEE_CORRECTION_HARD_DELETED',
    LEDGER_ENTRY_HARD_DELETED = 'LEDGER_ENTRY_HARD_DELETED',
}
